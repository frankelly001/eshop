...
const CheckoutPay = () => {
  ...
  const { firstname, lastname, email, phone1, phone2, city, number, street } =
    userDelivery;
      ...
      <div className="checkout_pay-container">
        <div className="checkout_pay-content">
          <div className="details-title">
            ...
            <p onClick={() => handleViewDetails("delivery")}>
              see details {">"}
            </p>
          </div>
          ...
          <ViewDetails
            detailType="delivery"
            viewSwitch={viewDetails.delivery}
            onHandleView={handleViewDetails}
        ...
        <button
          ...
          className="paynow"
        >{`Pay now: ${formatToCurrency(total)}`}</button>
